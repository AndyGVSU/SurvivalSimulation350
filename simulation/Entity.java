...
public abstract class Entity implements Serializable {
    ...
    /** Which simulation this entity belongs to. */
    ...
    private int color;
    /** Depth is "distance" from initial plant-entity. "0" depth
     * is main plant. */
    private int depth;
     ...
     * @param initRow   The "y" coordinate of this entity.
     * @param initCol   The "x" coordinate of this entity.
     */
    public Entity(final MainSimulation sim, final Entity flow,
                  final int initDepth, final int initRow,
                  final int initCol) {
        this.simulation = sim;
        this.flowTo = flow;
    ...
    /**
     * Sets the color of a type of entity.
     * @param newColor    The color to set this entity to.
     */
     ...
     * @param initRow    The "y" coordinate of this entity.
     * @param initCol    The "x" coordinate of this entity.
     * @return    The entity in the space specified.
     */
    public Entity checkAdjacent(
            final AdjacentEntities direction,
            final int initRow,
            final int initCol) {
        switch (direction) {
        case UP:
        ...
        case DOWN:
            return simulation.getEntity(initRow + 1, initCol);
        case LEFT:
            return simulation.getEntity(initRow, initCol - 1);
        case RIGHT:
            return simulation.getEntity(initRow, initCol + 1);
        case HERE:
            return simulation.getEntity(initRow, initCol);
        default:
            return null;
        }
    }
