...
public class Grass extends Plant {
    ...
    public final boolean canGrowLeaf() {
        Entity left = checkAdjacent(
                AdjacentEntities.LEFT, this.getRow(), this.getColumn());
        Entity right = checkAdjacent(
                AdjacentEntities.RIGHT, this.getRow(), this.getColumn());
    ...
    public final void growPlant() {
        if (checkAdjacent(AdjacentEntities.UP,
    ...
    public final void growLeaf() {
        if (checkAdjacent(AdjacentEntities.LEFT,
                this.getRow(), this.getColumn())
                instanceof Air) {
            Leaf l = new Leaf(simulation, this,
                    this.getDepth() + 1,
                    this.getRow(), this.getColumn() - 1);
            nutrientsFrom.add(l);
            simulation.setEntity(this.getRow(),
                    this.getColumn() - 1, l);
        } else if (checkAdjacent(AdjacentEntities.RIGHT,
                this.getRow(),
                this.getColumn())
                instanceof Air) {
            Leaf l = new Leaf(simulation, this,
    ...
    public final void growRoot() {
        ...
        while (tempRow < simulation.getRows() - 1) {
            ...
            if (checkAdjacent(AdjacentEntities.DOWN,
            ...
            if (checkAdjacent(AdjacentEntities.LEFT,
                ...
                Root r = new Root(simulation,
                        simulation.getEntity(tempRow, this.getColumn()),
                        tempRow - this.getRow() + 1, tempRow,
                        this.getColumn() - 1);
                simulation.setEntity(tempRow,
                        this.getColumn() - 1, r);
                nutrientsFrom.add(r);
                break;
            }
    ...
    public final void growFruit() {
        Entity e = checkAdjacent(AdjacentEntities.LEFT,
                this.getRow(), this.getColumn());
